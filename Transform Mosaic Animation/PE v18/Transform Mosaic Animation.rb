...
# bo4p5687 for update
#===============================================================================
class PokemonBattlerSpriteTransform < PokemonBattlerSprite
  attr_reader :mosaic
  def initialize(*args)
    super(*args)
    @mosaic=0
...
class PokeBattle_Scene
  def pbChangePokemonTransform(idxBattler,pkmn)
    ...
    if pkmnSprite.pkmn
      ...
      pkmnSprite2=PokemonBattlerSpriteTransform.new(@viewport,sideSize,idxBattler,@animations)
